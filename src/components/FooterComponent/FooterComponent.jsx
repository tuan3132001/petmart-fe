    ...
    <>
      ...
      >
        <div>
          ...
          >
            Đăng nhập vào PetMart
          </h1>
        </div>
        <div
          style={{ marginTop: "20px", fontSize: "11.2px", color: "#6B6B6B" }}
        >
          Bản quyền © 2001–2024 Petmart.com™. Bảo lưu mọi quyền.
        </div>
        <div>
          <h1
            style={{
          ...
          >
            Petmart.com là shop phụ kiện thú cưng hàng đầu thành phố về chất
            lượng và các dịch vụ liên quan.
          </h1>
        </div>
        <div>
          <ul
