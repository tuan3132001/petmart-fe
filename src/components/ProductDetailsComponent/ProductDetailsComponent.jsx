        ...
        <div className="mt-[10px] mr-0  py-[10px] px-0 border-t-[1px] border-b-[1px] border-solid border-[#e5e5e5] ">
          ...
          <div className="flex  items-center w-[100px]">
            <div className="rounded-[4px] border-[1px] border-solid border-[#ccc] w-[100px] flex mt-[10px]">
              <button onClick={()=>handleChangeCount('increase',numProduct === productDetails?.countInStock)} className="cursor-pointer w-1/3 border-none bg-transparent flex items-center justify-center">
              ...
              <input
                ...
                defaultValue={1}
              />
              <button onClick={()=>handleChangeCount('decrease',numProduct === 1)} className="cursor-pointer w-1/3 border-none bg-transparent flex items-center justify-center">
