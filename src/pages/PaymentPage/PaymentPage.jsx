...
const PaymentPage = () => {
  ...
  const diliveryPriceMemo = useMemo(() => {
    if (delivery === "fast") {
      return diliveryPrice + 10000;
    } else {
      return diliveryPrice;
    }
  }, [delivery, diliveryPrice]);
  ...
  const handleAddOrder = () => {
    if (
      ...
      mutationAddOrder.mutate({
        ...
        shippingPrice: diliveryPriceMemo != null ? diliveryPriceMemo : 0,
  ...
  return (
    <div style={{ background: "#f5f5fa", with: "100%", height: "2000px" }}>
      <Loading isPending={isPendingAddOrder}>
        <div style={{ height: "100%", width: "1270px", margin: "0 auto" }}>
          <h3 className="text-center font-bold text-[20px] mb-[10px]">
            Thanh toán
          </h3>
          <Button type="text" icon={<LeftOutlined />} onClick={handleGoBack} className="mb-[10px]">
            Trở về
          </Button>
                  ...
                  <WrapperRadio onChange={handleDilivery} value={delivery}>
                    <Radio value="fast">
                      ...
                      <span className="text-[12px] text-[gray]">
                        +10.000VND (dự kiến giao trong 1-2 ngày)
                      </span>
                    </Radio>
                    <Radio value="gojek">
                      <span style={{ color: "#ea8500", fontWeight: "bold" }}>
