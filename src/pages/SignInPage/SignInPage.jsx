    ...
    <div className="flex items-center justify-center bg-[rgba(0,0,0,0.53)] h-[100vh]">
      <div className="w-[800px] h-[445px] rounded-[6px] bg-white flex">
        <div className="flex-1 p-[40px] md:p-[45px] pb-[24px] flex flex-col">
          ...
          <p className="mt-[15px] mb-[10px] text-[15px] font-[400]">Đăng nhập và tạo tài khoản</p>
          <InputForm className='mb-[10px] border-b border-gray-300 focus:outline-none focus:border-none focus:border-b-2 focus:border-blue-500 focus:bg-blue-100' placeholder='abc@gmail.com' />
          ...
          <p className="text-blue-500 text-[13px] cursor-pointer">Quên mật khẩu?</p>
          <p className="text-[13px]">Bạn chưa có tài khoản? <span className="text-blue-500 text-[13px] cursor-pointer">Tạo tài khoản</span></p>
        </div>
